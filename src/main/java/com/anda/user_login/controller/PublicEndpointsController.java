...
import com.anda.user_login.services.UserRegistrationService;
...
public class PublicEndpointsController {
    ...
    @PostMapping("/test")
    public Object testToken(@AuthenticationPrincipal User user) {
        try{
            return  authenticationService.authenticateByToken(user.getToken());
